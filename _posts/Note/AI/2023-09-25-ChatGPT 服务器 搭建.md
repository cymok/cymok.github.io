...
方案1：qiang外 IP 服务器 + ChatGPT(key)

方案2：qiang内 IP 服务器 + ChatGPT(key) + 代理

方案3；本地搭建, 只需 ChatGPT(key) + 代理
...
Docker 官方镜像 `chenzhaoyu94/chatgpt-web:latest` (ChatGPT 3.5, 训练数据 2021年10月)

阿里云镜像 `registry.cn-hangzhou.aliyuncs.com/generative/chatgpt-web` (ChatGPT 3.5, 训练数据 2021年07月)
